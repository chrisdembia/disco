...
void RootNotifiee::handleNotificationException( AttributeId aid )
{
   onNotificationException(aid);
}

void RootNotifiee::handleNotificationException()
{
   onNotificationException();
}
void RootNotifiee::onDelete( ) {}
uint32_t RootNotifiee::auditErrors( uint32_t ) const { return 0; }
...
string RootNotifiee::attributeString( RootNotifiee::AttributeId a )
{
   ...
   switch (a)
   {
       case _nullNotification: str = "_nullNotification"; break;
       ...
       // TODO case _notificationException: str = "_notificationException"; break;
       // TODO case _notificationAttribute: str = "_notificationAttribute"; break;
